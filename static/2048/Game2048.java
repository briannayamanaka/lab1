 ...
 * File: Game2048.java
 * Sources of Help: Prof Leo, TAs, tutors, textbooks, piazza, java api
 * Describe: Game2048.java is the main file where we can test all of our
 * other files/ constructors and methods. This file puts it all together! Han
 * dles command line argument processing, allows us to pass parameters..and
 * run the game.
 */
